## Dialogue balloon for the TARDIS, styled for the 640x320 pixel-art viewport.
##
## Adapted from Dialogue Manager's example balloon; the flow control is theirs,
## the presentation is ours. Kept as a copy rather than a subclass so an addon
## update cannot silently change how dialogue looks.

class_name TardisBalloon extends CanvasLayer
